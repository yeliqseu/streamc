/*
 * Test streaming coding over a link with Bernoullis random packet loss.
 * The simulation uses a mixture of full-length and short-length encoding window.
 * See [R] Y. Li, X. Chen, Y. Hu, R. Gao, J. Wang and S. Wu, "Low-Complexity Streaming Forward Erasure Correction for Non-Terrestrial Networks," 
 *         in IEEE Transactions on Communications, vol. 71, no. 12, pp. 6870-6883, Dec. 2023, doi: 10.1109/TCOMM.2023.3313615.
 */
#include <stdio.h>
#include <stdlib.h>
#include <unistd.h>
